...
---
--- LATER: The following "Download:" line was generated by `hs.spoons.newSpoon`,
---        so I'm guessing the comments in this file are interpreted as
---        Markdown and used by Hammerspoon to generate help and web text,
---        but I haven't investigated further. (So we'll remove this comment
---        and adjust comments as necessary if/when we seek to get this Spoon
---        canonicalized within Hammerspoon proper.)
---
